  ...
  return (
    <footer className="bg-base-100">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a className="hover:underline">MSIB Tracker™</a>. Developed Muhammad Farhan Nabil.
            </span>
            <div className="flex mt-4 sm:justify-center sm:mt-0">
                <a href="https://instagram.com/farhaaan____" target='_blank' className="text-gray-500 hover:scale-105 hover:text-gray-900 dark:hover:text-white ms-5 -mx-3">
                ...
                <a href="https://www.linkedin.com/in/muhammad-farhan-nabil/" target='_blank' className="text-gray-500 hover:scale-105 hover:text-gray-900 dark:hover:text-white ms-5">
                <svg xmlns="http://www.w3.org/2000/svg" className='size-5 dark:bg-white dark:rounded-md' stroke="white" viewBox="0 0 50 50">
