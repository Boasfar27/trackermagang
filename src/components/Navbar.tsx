        ...
        <>
            ...
            <div className="modal" role="dialog">
                <div className="modal-box max-w-2xl">
                    ...
                    <p className="py-4 text-gray-400"> Jika ingin menambah jumlah batas perusahaan, ada masalah teknis, atau yang lainnya. Coba <a className='underline text-blue-500' target='_blank' href='https://instagram.com/farhaaan____'>DM aku</a> menyertakan ID User, terus ada kendala apa masbro.</p>
